...
public class RPG {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Limpar tela (funciona apenas em terminal real)
        try {
            if (System.getProperty("os.name").contains("Windows")) {
                new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor();
            } else {
        ...
        Inimigo inimigo2 = new Inimigo("Goblin Elite", 160, 14, 15,"D");
        Inimigo inimigo3 = new Inimigo("Lobo Negro", 120, 18, 10,"D");
        Inimigo inimigo4 = new Inimigo("Orc Rei", 230, 25, 20, "C");
        Inimigo inimigo5 = new Inimigo("Zar Nekhul", 750
        , 45, 38, "B");
